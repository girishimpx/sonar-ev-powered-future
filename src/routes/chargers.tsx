  ...
  head: () => ({
    meta: [
      { title: "Franchise Model | SONAR.EV" },
      {
        name: "description",
        content:
          "How the SONAR.EV franchise works: 5-step model, 95/5 revenue share, chargers from 30kW to 240kW, software and AMC included.",
      },
      { property: "og:title", content: "Franchise Model | SONAR.EV" },
      {
        property: "og:description",
        content:
          "SONAR.EV supplies chargers, software, and support. You own the site and earn 95% of net revenue.",
      },
...
const provides = [
  {
    icon: Zap,
    t: "Fast DC & AC Chargers",
    d: "30 kW to 240 kW commercial-grade hardware, OCPP-compliant.",
  },
  {
    icon: Cpu,
    t: "Charging Management Software",
    d: "Live monitoring, pricing, sessions, and payments in one dashboard.",
  },
  {
    icon: Smartphone,
    t: "Driver Mobile App",
    d: "QR charging, RFID, wallet, and network discovery for EV drivers.",
  },
  {
    icon: Activity,
    t: "Remote Monitoring",
    d: "24/7 remote diagnostics and health monitoring across the network.",
  },
  {
    icon: Wrench,
    t: "Preventive + Corrective AMC",
    d: "Scheduled visits, spare parts, and emergency support.",
  },
  {
    icon: BarChart3,
    t: "Business Analytics",
    d: "Revenue, utilization, and performance analytics per station.",
  },
  {
    icon: HeartHandshake,
    t: "Installation & Training",
    d: "Site assessment, commissioning, and staff training.",
  },
  {
    icon: LineChart,
    t: "Marketing & Network Listing",
    d: "Discoverable on the SONAR.EV network and driver app.",
  },
];
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_1fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
              Build India's EV charging future.
              <br />
              <span className="text-white/50">We power it. You profit.</span>
            </h1>
            <p className="mt-6 max-w-xl text-white/60">
              SONAR.EV supplies the chargers, software, installation, and support. You own the
              station and earn 95% of net revenue — a partner-first franchise model designed to
              scale.
            </p>
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-6 lg:grid-cols-2 lg:items-center">
        ...
        <div>
          <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">
            The most partner-first split in India.
          </h2>
          <p className="mt-4 text-white/60">
            Revenue share is calculated on <span className="text-white">net revenue</span> — after
            electricity charges, payment gateway fees, applicable taxes, and other approved
            operating expenses. Transparent, monthly, auditable.
          </p>
          <Link to="/calculator" className={`${btnSecondary} mt-6`}>
            Open the earnings calculator <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      </div>
    </section>
  ...
  const steps = [
    {
      n: "01",
      t: "You invest",
      d: "Franchise partner invests in the station and secures a suitable site.",
    },
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl">
            From investment to recurring revenue
          </h2>
        </div>
  ...
  return (
    <section className="py-20 md:py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center">
          <div className="text-xs font-medium uppercase tracking-[0.2em] text-white/50">
            What SONAR.EV Provides
          </div>
          <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl">
            A full-stack charging platform
          </h2>
        </div>
    ...
    <section className="py-20 md:py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl">
            Charger capacities to fit your site
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-white/60">
            Final pricing depends on location, electrical infrastructure, civil work, and charger
            configuration. Share your site and we'll build a proposal.
          </p>
        </div>
        <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          {capacities.map((c) => (
            <div
              key={c.power}
              className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 transition-all hover:-translate-y-1 hover:border-white/30"
            >
        ...
        <div className="mt-10 flex justify-center">
          <Link to="/contact" className={btnPrimary}>
            Become a Franchise Partner <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      </div>
    </section>
