...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Apply for a SONAR.EV EV charging franchise. 95% revenue share, full infrastructure and support." },
...
const channels = [
  { icon: Phone, label: "Call us", value: "+91 70197 21320", href: "tel:+917019721320", sub: "Mon–Sat, 9am – 8pm IST" },
  { icon: Mail, label: "Email us", value: "franchise@sonarev.in", href: "mailto:franchise@sonarev.in", sub: "Response within 24 hours" },
  { icon: MessageCircle, label: "WhatsApp", value: "Chat instantly", href: "https://wa.me/917019721320?text=Hi%20SONAR.EV%2C%20I%27m%20interested%20in%20the%20franchise%20program.", sub: "Fastest way to reach us" },
];
    ...
    <div className="min-h-screen bg-black text-white antialiased">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 md:py-28">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs text-white/70">Become a Franchise Partner</div>
            ...
            <p className="mt-6 max-w-xl text-white/60">
              Own an EV charging station backed by enterprise chargers, software, installation, and support.
              Share your details and a franchise specialist will reach out within 24 hours.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-white/10 bg-white/[0.02] py-12">
        <div className="mx-auto grid max-w-7xl gap-3 px-6 sm:grid-cols-3">
          {channels.map(({ icon: Icon, label, value, sub, href }) => (
            <a key={label} href={href} className="group flex items-start gap-4 rounded-2xl border border-white/10 bg-black p-6 transition-all hover:-translate-y-0.5 hover:border-white/30">
      ...
      <section className="py-20 md:py-28">
        <div className="mx-auto grid max-w-7xl gap-14 px-6 lg:grid-cols-[1fr_1.15fr]">
          <div>
            <div className="text-xs font-medium uppercase tracking-[0.2em] text-white/50">Franchise application</div>
            <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">Tell us about you & your site</h2>
            <p className="mt-4 text-white/60">
              Share a few details and a SONAR.EV franchise specialist will reach out within 24 hours with a
              site assessment and tailored proposal.
            </p>
            <ul className="mt-8 space-y-3 text-sm">
              {["Free site & feasibility consultation", "Investment & ROI proposal for your site", "Hardware + software + AMC included", "5-year renewable franchise agreement"].map((t) => (
            ...
            <p className="mt-6 text-xs text-white/40">
              ...
              Actual earnings depend on utilization, electricity tariffs, local demand, and operating costs.
            </p>
          </div>
