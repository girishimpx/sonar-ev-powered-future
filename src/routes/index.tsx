  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SONAR.EV Franchise — Own an EV Charging Station in India" },
      {
        ...
        content:
          "Build India's EV charging future. We power it. You profit. Enterprise-grade charging franchise with 95% revenue share.",
      },
...
const steps = [
  {
    n: "01",
    title: "You invest",
    body: "You invest in the charging station and secure a suitable site.",
  },
  { n: "02", title: "We supply", body: "SONAR.EV supplies chargers, software, and driver app." },
  {
    n: "03",
    title: "We install",
    body: "We install, commission, and connect the station to our network.",
  },
  {
    n: "04",
    title: "EVs charge",
    body: "Customers charge their EVs — payments captured automatically.",
  },
...
const whyCards = [
  {
    icon: TrendingUp,
    title: "Lowest Revenue Share",
    body: "Keep 95% of net revenue — one of the most partner-friendly splits in India.",
  },
  {
    icon: Cpu,
    title: "Enterprise Software Included",
    body: "Charging management platform, analytics, and driver app — all included, free.",
  },
  {
    icon: Wrench,
    title: "AMC Included",
    body: "Preventive and corrective maintenance handled by SONAR.EV engineers.",
  },
  {
    icon: LineChart,
    title: "AI Business Dashboard",
    body: "Real-time revenue, utilization, and health metrics for every station.",
  },
  {
    icon: HeartHandshake,
    title: "Dedicated Account Manager",
    body: "A single point of contact for operations, support, and expansion.",
  },
  {
    icon: Layers,
    title: "Scalable & Future-Ready",
    body: "Start with one site. Scale to a network with a national brand behind you.",
  },
];

const faqs = [
  {
    q: "Who owns the charger?",
    a: "The franchise partner owns the charger and the station assets. SONAR.EV owns the software platform, brand, and network integration.",
  },
  {
    q: "Who pays the electricity bills?",
    a: "The franchise partner is responsible for electricity, internet, and day-to-day utilities. These are treated as approved operating expenses in the revenue-share calculation.",
  },
  {
    q: "How is revenue calculated?",
    a: "Revenue share is calculated on net revenue — after electricity, payment-gateway fees, applicable taxes, and other approved operating expenses. Partners receive 95%, SONAR.EV retains 5%.",
  },
  {
    q: "Can I own multiple stations?",
    a: "Yes. Partners in good standing can expand to additional sites with priority rights on new territories.",
  },
  {
    q: "Who maintains the charger?",
    a: "SONAR.EV provides preventive maintenance, remote monitoring, spare parts, and emergency support under the AMC.",
  },
  {
    q: "How long is the franchise agreement?",
    a: "The standard franchise agreement is 5 years, renewable, subject to performance and brand-guideline compliance.",
  },
  {
    q: "What happens if the charger fails?",
    a: "Our 24/7 technical helpdesk and field engineers respond under a defined SLA, with remote diagnostics and spare-parts support.",
  },
  {
    q: "Can I exit the agreement?",
    a: "The agreement includes clear termination clauses and exit procedures. A specialist will walk you through the terms during consultation.",
  },
];
...
function Index() {
  return (
    <div className="min-h-screen bg-black text-white antialiased">
      ...
      <WhySection />
      <ContactStrip>
        Ready to power a station? Talk to a SONAR.EV franchise specialist.
      </ContactStrip>
      <LeadSection />
      <FaqSection />
      <Footer />
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-6 pt-16 pb-24 md:pt-24 md:pb-32 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <p className="mt-6 max-w-xl text-base leading-relaxed text-white/60 sm:text-lg">
            ...
            intelligent software, nationwide support, and recurring revenue. We power it. You
            profit.
          </p>
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-[1fr_1.1fr] lg:items-center">
          <div className="rounded-3xl border border-white/10 bg-black p-8">
            ...
            <div className="mt-6 h-4 w-full overflow-hidden rounded-full border border-white/10 bg-white/5">
              <div className="flex h-full">
                <div
                  className="flex h-full items-center justify-end bg-white pr-3 text-[10px] font-semibold text-black"
                  style={{ width: "95%" }}
                >
                  95%
                </div>
          ...
          <div>
            ...
            <p className="mt-4 text-white/60">
              The revenue share is calculated <span className="text-white">after</span> electricity
              charges, payment gateway fees, applicable taxes, and other approved operating expenses
              — ensuring a transparent and sustainable partnership for both sides.
            </p>
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-14 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
          {provides.map((t) => (
            <div
              key={t}
              className="flex items-start gap-2.5 rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3.5"
            >
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-14 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {responsibilities.map(({ icon: Icon, t }) => (
            <div
              key={t}
              className="flex items-center gap-3 rounded-2xl border border-white/10 bg-black p-5"
            >
      ...
      <div className="mx-auto grid max-w-7xl gap-14 px-6 lg:grid-cols-2 lg:items-center">
        ...
        <div>
          ...
          <p className="mt-4 text-white/60">
            ...
            network delivers proactive maintenance, remote diagnostics, and rapid on-ground
            response.
          </p>
  ...
  const cards = [
    {
      ...
      items: [
        ...
        "Revenue share: 95% partner / 5% SONAR.EV",
        "Termination clauses",
    ...
    <section id="contract" className="border-y border-white/10 bg-white/[0.02] py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeader
          ...
          title="Clear, professional, partner-first agreements"
        />
        <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {cards.map((c) => (
            <details
              key={c.title}
              className="group rounded-2xl border border-white/10 bg-black p-6 open:border-white/25"
            >
              <summary className="flex cursor-pointer list-none items-center justify-between gap-3">
                <span className="text-base font-semibold">{c.title}</span>
                <span className="grid h-6 w-6 shrink-0 place-items-center rounded-full border border-white/15 text-white/60 transition-transform group-open:rotate-45">
                  +
                </span>
              </summary>
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {whyCards.map(({ icon: Icon, title, body }) => (
            <div
              key={title}
              className="group rounded-2xl border border-white/10 bg-white/[0.03] p-7 transition-colors hover:border-white/25"
            >
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr]">
            <div>
              ...
              <div className="mt-8 rounded-2xl border border-white/10 bg-white/[0.03] p-4 text-xs text-white/50">
                Note: Financial examples anywhere on this site are illustrative estimates based on
                your inputs. Actual results depend on utilization, tariffs, local demand, and
                operating costs.
              </div>
            </div>
            <EnquiryForm />
